...
const elements = {
  ...
  summaryFort: document.getElementById('summary-fort-value'),
  summaryReflex: document.getElementById('summary-reflex-value'),
  summaryWill: document.getElementById('summary-will-value'),
